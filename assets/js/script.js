...
clearBtn.addEventListener('click', function() {
    ...
    // Clear recipe history list
    recipeHistoryListEl.innerHTML = '';
    recipeHistoryContainerEl.style.display = "none";

    // Clear YouTube video, recipe title, and ingredients
    document.getElementById('youtube-video').src = ''; // Clear the video
    document.getElementById('recipe-title').innerText = ''; // Clear the recipe title
    document.getElementById('selected-ingredients').innerText = ''; // Clear the selected ingredients
    
    // Optionally hide the YouTube video section if you want
    document.getElementById('youtube-tutorial').style.display = 'none';
});
